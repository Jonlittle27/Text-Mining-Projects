...
#Word Frequency of the entire HP series
hpfull_wf <- hp_fullseries%>%
  count(word,sort=TRUE)

#Word Frequency No Stop of the entire HP Series
hpfull_wf_no_stop <- hpfull_wf%>%
  anti_join(stop_words)

#Importing single books of HP series 
#and creating word frequencies (nostop) of the top ten terms
#For this section a new working directory is needed with only this corpus
...
#Creating a tidy word frequency for HP1 to make a txt file for a wordcloud
...
#Percy Jackson WF top 10 no stop separated by individual book
...
#bar plots for the top ten most frequent words of PJ books
...
#Combining PJ and HP Series / creating a new total n value
...
#Fancy Jitter Scatter for PJ / HP
